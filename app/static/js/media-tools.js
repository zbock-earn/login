function renderMediaUI(slug) {
  ...
  if (slug.includes('video-to-gif-converter')) panel.innerHTML = uploadForm('/api/v1/media/video-to-gif','Convert to GIF','<input name="fps" type="number" min="5" max="24" value="12" class="w-full rounded border p-2 dark:bg-slate-800"/>');
