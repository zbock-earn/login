...
async def media_metadata(url: str = Form(...)) -> dict:
    low = url.lower()
    if 'youtube.com' in low or 'youtu.be' in low or 'tiktok.com' in low or 'instagram.com' in low:
        raise HTTPException(status_code=410, detail='Video downloader tools have been removed from this project.')
